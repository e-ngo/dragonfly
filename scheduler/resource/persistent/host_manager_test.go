	...
	tests := []struct {
	...
	}{
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host1")).SetVal(mockData)
			},
			expectedHost: &Host{
				ID:                 "host1",
		...
		},
		{
			...
			hostID: "host2",
			mockRedis: func(mock redismock.ClientMock) {
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host2")).SetVal(map[string]string{})
			},
			expectedHost:   nil,
		...
		},
		{
			...
			hostID: "host3",
			mockRedis: func(mock redismock.ClientMock) {
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host3")).SetErr(fmt.Errorf("Redis error"))
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host4")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host5")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host6")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host7")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host8")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host9")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host10")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host11")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host12")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host13")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host14")).SetVal(mockData)
			},
			expectedHost:   nil,
			expectedLoaded: false,
			expectedError:  false,
...
func TestHostManager_LoadAll(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "scan fails",
			mockRedis: func(mock redismock.ClientMock) {
				mock.ExpectSScan(pkgredis.MakePersistentHostsInScheduler(1), 0, "*", 10).
		...
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host1")).
				...
				// host2 load fails
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host2")).
		...
		},
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host3")).
					SetVal(map[string]string{
						"id":                                  "host3",
						"type":                                "normal",
						"hostname":                            "hostname1",
				...
				// Second scan
				mock.ExpectSScan(pkgredis.MakePersistentHostsInScheduler(1), 123, "*", 10).
					SetVal([]string{"host4"}, 0)
				mock.ExpectHGetAll(pkgredis.MakePersistentHostKeyInScheduler(1, "host4")).
					SetVal(map[string]string{
						"id":                                  "host4",
						"type":                                "normal",
						"hostname":                            "hostname1",
...
func TestHostManager_LoadRandom(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			mockRedis: func(mock redismock.ClientMock) {
				mock.ExpectSMembers(pkgredis.MakePersistentHostsInScheduler(1)).
